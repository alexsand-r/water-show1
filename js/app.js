(() => {
    ...
    function initSliders() {
        if (document.querySelector(".we__slider")) new core(".we__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".fantastic__slider")) new core(".fantastic__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".we-are__slider")) new core(".we-are__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        var logoFooter = document.querySelector(".menu-footer__logo-footer");
        var blockMenuFooter = document.querySelector(".block-menu-footer");
        var originalParent = null;
        if (button && logoFooter && blockMenuFooter) button.addEventListener("click", (function() {
            if (originalParent === null) {
                originalParent = logoFooter.parentElement;
                blockMenuFooter.appendChild(logoFooter);
            } else {
                originalParent.insertBefore(logoFooter, originalParent.firstChild);
                originalParent = null;
            }
        }));
    }));
    var bullets = document.querySelectorAll(".swiper-pagination-bullet");
    var activeIndex = Array.from(bullets).findIndex((function(bullet) {
        return bullet.classList.contains("swiper-pagination-bullet-active");
    }));
    if (activeIndex !== -1 && activeIndex < bullets.length - 1) {
        var nextBullet = bullets[activeIndex + 1];
        nextBullet.style.backgroundColor = "red";
    }
    const slider = document.querySelector(".add__slider");
    let mySwiper;
    function script_initSliders() {
        if (document.querySelector(".add__slider")) {
            if (window.innerWidth <= 460 && slider.dataset.mobile == "false") if (document.querySelector(".add__slider")) {
                mySwiper = new core(".add__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
